...
public interface ITechnicalResponsibleDAO {
    ...
    TechnicalResponsible findById(int idTechnicalResponsible) throws ServiceException, ValidationException;
    ...
    boolean update(TechnicalResponsible technicalResponsible)
            throws ServiceException, ValidationException;
    boolean delete(int idTechnicalResponsible) throws ServiceException, ValidationException;
}