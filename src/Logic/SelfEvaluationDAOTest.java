...
class SelfEvaluationDAOTest extends BaseDAOTest {
    ...
    void save_withValidData_returnsOneRowAffected() throws Exception {
        ...
        int result = dao.save(selfEvaluation);
    ...
    @Test
    void save_thenGetAll_containsSavedSelfEvaluation() throws Exception {
    ...
    @Test
    void save_duplicatePeriodSamePracticante_throwsSQLException() throws Exception {
        dao.save(buildValidSelfEvaluation());

        // UNIQUE KEY uq_autoev_prac_periodo
        assertThrows(Exception.class,
                () -> dao.save(buildValidSelfEvaluation()),
                "No debe permitir dos autoevaluaciones del mismo periodo para el mismo practicante");
    }

    @Test
    void save_withDifferentPeriod_isAccepted() throws Exception {
